...
type CheckpointOracle struct {
	...
	CheckpointOracleTransactor 
	CheckpointOracleFilterer   
}
...
type CheckpointOracleCallerSession struct {
	Contract *CheckpointOracleCaller 
	CallOpts bind.CallOpts           
}
...
type CheckpointOracleTransactorSession struct {
	Contract     *CheckpointOracleTransactor 
	TransactOpts bind.TransactOpts           
}
...
type CheckpointOracleNewCheckpointVoteIterator struct {
	Event *CheckpointOracleNewCheckpointVote 
